...
/*IO定义*/
/*2.8寸TFT触摸屏接口定义*/
#define  RS_CLR	        GPIO_ResetBits(GPIOC, GPIO_Pin_10)   //RS置低
#define  RS_SET	        GPIO_SetBits(GPIOC, GPIO_Pin_10)     //RS置高
#define  RW_CLR	        GPIO_ResetBits(GPIOA, GPIO_Pin_9)   //RW置低
#define  RW_SET	        GPIO_SetBits(GPIOA, GPIO_Pin_9)  	//RW置高
#define  RD_CLR	        GPIO_ResetBits(GPIOA, GPIO_Pin_8)   //E置低
#define  RD_SET	        GPIO_SetBits(GPIOA, GPIO_Pin_8)     //E置高
...
//************************************************************************
#define Key_1()						GPIO_ReadInputDataBit(GPIOC,GPIO_Pin_11)
#define Key_2()						GPIO_ReadInputDataBit(GPIOC,GPIO_Pin_12)
#define Key_3()						GPIO_ReadInputDataBit(GPIOD,GPIO_Pin_2)
#define Key_4()						GPIO_ReadInputDataBit(GPIOB,GPIO_Pin_5)
